...
public class ModelTest {
	...
	public void testSum() {
		...
		// The purpose of this test is to make sure all If statements are
		// tested.
		m.reset();
		m.addToEntry("4");
		m.enterValue();
	...
	public void testFactorial() {
		...
		// Case 3: Testing a number on screen, with non-empty stack of stored
		// values.
		m.reset();
		m.addToEntry("3");
		m.enterValue();
	...
	// Testing ExpressionHist() method that enters the symbol "x" to all the
	...
	public void testExpressionHist() {
		...
		// Case 2: Stacks are filled, testing the functionality of undo function
		// that involves stack,
		// Brackets with previous operations and return statement of
		// expressionHist.
		m.addToEntry("1");
		m.enterValue();
		m.enterHistory();
