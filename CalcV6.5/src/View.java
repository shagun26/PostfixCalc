...
public class View extends JFrame
{
	...
	private static final int MANAGEMENT_WIDTH = 50;
	private static final int MANAGEMENT_HEIGHT = 50;
	...
	private GridLayout window_layout_manager = new GridLayout(4, 1);
	private GridLayout display_layout_manager = new GridLayout(2, 1);
	private GridLayout management_layout_manager = new GridLayout(1,1);
	private GridLayout keypad_layout_manager = new GridLayout(4, 3);
	private GridLayout operator_layout_manager = new GridLayout(2, 4);
	...
	public View()
	{
		...
		management.setPreferredSize(new Dimension(MANAGEMENT_WIDTH, MANAGEMENT_HEIGHT));
		management.setLayout(management_layout_manager);
		...
		management.add(new ButtonAdapter(CLEAR)
		{
			public void pressed()
			{
				controller.clear();
		...
		keypad.add(new ButtonAdapter(DECIMAL_POINT)
		{
			public void pressed()
			{
		...
		operators.add(new ButtonAdapter(FACTORIAL)
		{
			public void pressed()
			{
				controller.factorial();
				controller.historyOperation(FACTORIAL);
			}
		...
		operators.add(new ButtonAdapter(PLUSMINUS)
		{
			...
			{
				controller.negate();
				controller.historyOperation(PLUSMINUS);
			}
		...
		operators.add(new ButtonAdapter("COS")
		{
			...
			{
				controller.cos();
				controller.historyOperation(COS);
			}
		...
		operators.add(new ButtonAdapter("SIN")
		{
			...
			{
				controller.sin();
				controller.historyOperation(SIN);
			}
